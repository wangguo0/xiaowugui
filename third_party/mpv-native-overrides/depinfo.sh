...
dep_expat=()
dep_freetype2=()
dep_fontconfig=(freetype2 expat)
dep_fribidi=()
dep_harfbuzz=()
dep_unibreak=()
...
ci_tarball="prefix-ndk-${v_ndk}-lua-${v_lua}-unibreak-${v_unibreak}-harfbuzz-${v_harfbuzz}-fribidi-${v_fribidi}-freetype-${v_freetype}-expat-${v_expat}-fontconfig-${v_fontconfig}-mbedtls-${v_mbedtls}-nghttp2-${v_nghttp2}-curl-${v_curl}-ffmpeg-${v_ci_ffmpeg}.tgz"
