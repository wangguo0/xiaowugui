...
- **站点注入**:添加自定义 WebHome 或通用 CSP 站点,可配置启用状态、插入位置、首页、搜索和换源行为。
- **WebHome 扩展**:给真实网页注入用户脚本,来源支持本地文件、远程链接/manifest、直接代码、表单生成或 JSON;提供调试工作台用于 Web 预览、Console/Network/Elements 和代码保存预览。
